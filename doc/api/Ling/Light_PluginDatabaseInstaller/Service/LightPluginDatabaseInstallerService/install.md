...
LightPluginDatabaseInstallerService::install
================



LightPluginDatabaseInstallerService::install — Installs the database part of the given plugin.
...
Source Code
===========
See the source code for method [LightPluginDatabaseInstallerService::install](https://github.com/lingtalfi/Light_PluginDatabaseInstaller/blob/master/Service/LightPluginDatabaseInstallerService.php#L97-L107)
