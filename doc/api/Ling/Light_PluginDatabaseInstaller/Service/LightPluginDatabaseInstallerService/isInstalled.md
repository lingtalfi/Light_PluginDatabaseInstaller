...
LightPluginDatabaseInstallerService::isInstalled
================



LightPluginDatabaseInstallerService::isInstalled — Returns whether the given plugin's database part is installed.
...
public [LightPluginDatabaseInstallerService::isInstalled](https://github.com/lingtalfi/Light_PluginDatabaseInstaller/blob/master/doc/api/Ling/Light_PluginDatabaseInstaller/Service/LightPluginDatabaseInstallerService/isInstalled.md)(string $pluginName) : bool
...
Source Code
===========
See the source code for method [LightPluginDatabaseInstallerService::isInstalled](https://github.com/lingtalfi/Light_PluginDatabaseInstaller/blob/master/Service/LightPluginDatabaseInstallerService.php#L116-L123)
